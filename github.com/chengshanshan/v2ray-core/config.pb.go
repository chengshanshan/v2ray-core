...
import (
	transport "github.com/chengshanshan/v2ray-core/transport"
...
type Config struct {
	...
	App []*any1.Any `protobuf:"bytes,4,rep,name=app,proto3" json:"app,omitempty"`
	// Transport settings.
	...
	// initialization.
	Extension []*any1.Any `protobuf:"bytes,6,rep,name=extension,proto3" json:"extension,omitempty"`
}
...
func (x *Config) GetExtension() []*any1.Any {
	if x != nil {
		return x.Extension
	}
	return nil
...
type InboundHandlerConfig struct {
	...
	ReceiverSettings *any1.Any `protobuf:"bytes,2,opt,name=receiver_settings,json=receiverSettings,proto3" json:"receiver_settings,omitempty"`
	// Settings for inbound proxy. Must be one of the inbound proxies.
	ProxySettings *any1.Any `protobuf:"bytes,3,opt,name=proxy_settings,json=proxySettings,proto3" json:"proxy_settings,omitempty"`
}
...
func (x *InboundHandlerConfig) GetReceiverSettings() *any1.Any {
	if x != nil {
...
func (x *InboundHandlerConfig) GetProxySettings() *any1.Any {
	if x != nil {
...
type OutboundHandlerConfig struct {
	...
	SenderSettings *any1.Any `protobuf:"bytes,2,opt,name=sender_settings,json=senderSettings,proto3" json:"sender_settings,omitempty"`
...
func (x *OutboundHandlerConfig) GetSenderSettings() *any1.Any {
	if x != nil {
...
func (x *OutboundHandlerConfig) GetProxySettings() *any1.Any {
	if x != nil {
		return x.ProxySettings
	}
	return nil
...
var file_config_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x07, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x42, 0x49, 0x0a, 0x0e, 0x63, 0x6f,
	0x6d, 0x2e, 0x76, 0x32, 0x72, 0x61, 0x79, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x50, 0x01, 0x5a, 0x28,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x63, 0x68, 0x65, 0x6e, 0x67,
	0x73, 0x68, 0x61, 0x6e, 0x73, 0x68, 0x61, 0x6e, 0x2f, 0x76, 0x32, 0x72, 0x61, 0x79, 0x2d, 0x63,
	0x6f, 0x72, 0x65, 0x3b, 0x63, 0x6f, 0x72, 0x65, 0xaa, 0x02, 0x0a, 0x56, 0x32, 0x52, 0x61, 0x79,
